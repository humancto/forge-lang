...
{\large First Edition — v0.7.1}\\[0.3cm]
{\large March 2026}
\end{center}
\vspace*{\fill}
\newpage
...
Visit \url{https://humancto.github.io/forge-lang/} for documentation and \url{https://github.com/humancto/forge-lang} for source code.\\[1em]
